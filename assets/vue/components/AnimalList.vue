          ...
          <a :href="`/${animal.id}`" class="block">
            <div class="animal bg-white rounded-lg shadow-md p-4 flex items-center">
              <div class="animal-photo flex-shrink-0">
                <img v-if="animal.photos.length" :src="animal.photos[0]" :alt="animal.name" class="w-32 h-32 object-cover" />
                <img v-else src="/images/Pas-dimage-disponible.jpg" alt="Pas d'image" class="w-32 h-32 object-cover" />
              </div>
